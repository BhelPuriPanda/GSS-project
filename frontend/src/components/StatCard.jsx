    ...
    <div className="module-card group cursor-default p-6 hover:bg-[#cffd01]/[0.02]">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex flex-col items-end gap-1">
          <div className={`text-[10px] font-black uppercase tracking-widest ${trend.includes('+') ? 'text-[#cffd01]' : 'text-slate-600'}`}>
            {trend}
          </div>
      ...
      <div className="absolute -bottom-2 -right-2 text-[48px] font-black text-white/[0.01] pointer-events-none italic select-none">
        {title.slice(0, 4)}
      </div>
    </div>
  );
