import { Search, Bell, User, LayoutDashboard, ShieldAlert, Settings, LogOut, Terminal, Activity, Zap, Beaker } from 'lucide-react';
...
const Header = () => {
  ...
  const navItems = [
    { path: '/dashboard', label: 'Registry', icon: <LayoutDashboard size={14} /> },
    { path: '/violations', label: 'Intelligence', icon: <ShieldAlert size={14} /> },
    { path: '/sandbox', label: 'Sandbox', icon: <Beaker size={14} /> },
  ];
