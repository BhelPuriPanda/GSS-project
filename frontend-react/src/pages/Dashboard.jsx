...
const Dashboard = () => {
  ...
  const stats = [
    { title: 'Secured Assets', value: (media?.length || 0), icon: <Shield size={18} />, trend: '+12' },
    { title: 'Active Monitors', value: (media?.length || 0) * 4, icon: <Globe size={18} />, trend: '+8' },
    { title: 'Safe Protocols', value: '100%', icon: <Lock size={18} />, trend: 'STABLE' },
  ];
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 gap-14 sm:grid-cols-2 lg:grid-cols-12 md:gap-x-16">
            {filteredMedia.map((item, index) => {
              // Custom pattern for grid variations
